...
Check in your fylr.yml that you do not have a conflicting plugin enabled: remove the line with easydb-custom-data-type-cerlthesaurus. 
...
```
Remove this one line and restart fylr.
